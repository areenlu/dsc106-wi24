...
//maxStudents = 40; // This will cause an error!
const number1 = 2;
const number2 = 3;
...
age = 21 // fill this in with your actual age!
if (age < 18) { 
...
function areValidEmails(inputList) {
  ...
  console.log(areValidEmails(list1)); 
  
  const list2 = ["alice@ucsd.edu", "bob@ucsd.edu", "eve@harvard.edu"];
  console.log(areValidEmails(list2)); 
  
  const list3 = ["alice", "bob@ucsd.edu"];
  console.log(areValidEmails(list3)); 